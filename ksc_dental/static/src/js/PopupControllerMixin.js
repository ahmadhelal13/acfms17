odoo.define('ksc_dental.PopupControllerMixin', function(require) {
    'use strict';
     ...
     *     to close. In DentalComponent, `showPopup` is conveniently declared to satisfy this requirement.
