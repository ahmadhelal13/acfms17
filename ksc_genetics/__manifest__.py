# -*- coding: utf-8 -*-
{
    ...
    'depends': ['ksc_clinic_base', 'ksc_prescription_model', 'ksc_rooster_type',    'account',
                'stock', 'contacts', 'mail', 'ksc_laboratory', 'ksc_radiology',
    ...
    'data': [
        ...
        'report/genetics_patient_file.xml',
        'views/views.xml',
