# -*- coding: utf-8 -*-
{
    ...
    'depends': ['ksc_clinic_base', 'ksc_prescription_model', 'ksc_rooster_type',    'account', 'stock', 'contacts', 'mail', 'ksc_laboratory', 'ksc_radiology',
    ...
    'data': [
        ...
        'report/depart_of_gynecology.xml',
        'report/ultrasound.xml',
        'report/ultrasound_form.xml',
        'report/obst_gyn_patient_file.xml',
        'views/views.xml',
