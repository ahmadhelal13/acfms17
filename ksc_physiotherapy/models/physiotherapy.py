...
class kscPhysiotherapy(models.Model):
    ...
    physiotherapist_id = fields.Many2one("res.partner", domain=lambda self: self._get_physician_domain(), ondelete="restrict", index=True, tracking=True)
    ...
    grp_exercise_ids = fields.One2many("physiotherapy.exercise.group.lines", "physiotherapy_id", string="Exercise group")
    ...
    hand_data_ids = fields.One2many("ksc.physiotherapy.note", "hand_data_id", string="Hand Note")
    lower_data_ids = fields.One2many("ksc.physiotherapy.note", "lower_data_id", string="Lower Note")
    upper_data_ids = fields.One2many("ksc.physiotherapy.note", "upper_data_id", string="Upper Note")
    lower_seldata_ids = fields.One2many("ksc.physiotherapy.selection.note", "lower_selectdata_id", string="Lower Selection Note")
    upper_seldata_ids = fields.One2many("ksc.physiotherapy.selection.note", "upper_selectdata_id", string="Upper Selection Note")

    appointment_id = fields.Many2one("ksc.physiotherapy.appointment", "Appointment")
    ...
    def default_get(self, fields):
        ...
        for line in hand_templates:
            vals.append((0, 0, {"name": line.name, "right_val": line.right_val, "left_val": line.left_val, "note_type": line.note_type, "sensory_val": line.sensory_val}))
        ...
        for line in lower_selection_templates:
            vals.append((0, 0, {"name": line.name, "right_val": line.right_val, "left_val": line.left_val, "selnote_type": line.selnote_type}))
