...
class ResCompany(models.Model):
    ...
    physiotherapy_calendar_weekends = fields.Boolean(string="Physio Show weekends?", default=True)
    physiotherapy_calendar_weeknumber = fields.Boolean(string="Physio Show week number?", default=True)
    physiotherapy_calendar_weekday = fields.Selection(selection=WEEKDAYS, string="Physio First day of week?", required=True, default="0")
    physiotherapy_calendar_allow_overlap = fields.Boolean(string="Physio Allow events overlap?", default=True)
    physiotherapy_calendar_disable_dragging = fields.Boolean(string="Physio Disable drag and drop?", default=False)
    physiotherapy_calendar_disable_resizing = fields.Boolean(string="Physio Disable resizing?", default=False)
    physiotherapy_calendar_snap_minutes = fields.Integer(string="Physio Default minutes when creating and resizing", default=15)
    physiotherapy_calendar_slot_minutes = fields.Integer(string="Physio Minutes per row", default=30)
    physiotherapy_calendar_min_time = fields.Float(string="Physio Calendar time range from", default=0.0)
    physiotherapy_calendar_max_time = fields.Float(string="Physio Calendar time range to", default=24.0)
    physiotherapy_calendar_start_time = fields.Float(string="Physio Start time", default=6.0)
...
class ResConfigSettings(models.TransientModel):
    ...
    physiotherapy_calendar_disable_resizing = fields.Boolean(string="Physio Disable resizing?", related="company_id.physiotherapy_calendar_disable_resizing", readonly=False)
    physiotherapy_calendar_snap_minutes = fields.Integer(
        string="Physio Default minutes when creating and resizing", related="company_id.physiotherapy_calendar_snap_minutes", readonly=False
    )
    physiotherapy_calendar_slot_minutes = fields.Integer(string="Physio Minutes per row", related="company_id.physiotherapy_calendar_slot_minutes", readonly=False)
