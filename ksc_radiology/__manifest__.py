# -*- coding: utf-8 -*-
{
    ...
    'depends': ['ksc_clinic_base', 'ksc_prescription_model', 'ksc_rooster_type',    'account', 'stock',
                'contacts', 'mail', 'ksc_laboratory', 'purchase', 'sale', 'website_partner', 'crm', 'payment', 'ksc_patient_report'],
